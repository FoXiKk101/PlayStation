...
export const openItemModal = (item) => {
    ...
    <div class="bigOrder">
        <p class="bigListItemPrice"><b>Price: </b>${item.price} USD</p>
        <div class="bigListItemCart">
            <img src="./assets/shoping.png" alt="cartImage" class="bigListItemCartIMG" data-category=${item.category} data-id=${item.id}>
        </div>
    </div>
    </li>
      <a>Close</a>
